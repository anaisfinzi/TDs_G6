...
public class IHMPhilo {
     ...
     * (lesFourchettes[].etat et lesPhilos[].etat) ne sont pas protégés.
     ...
     * différents). Il ne devrait pas y avoir des surprises lors d'une
    ...
    class Point {
        ...
        /** Changement de position, coordonnées polaires. */
    ...
    /* Initialise la fenètre d'affichage
     */
    public IHMPhilo (String nomstrategie, int _nbPhilosophes, Simulateur _simu)
    {
        ...
        // Quitter
        JButton jb_quitter = new IHMJoliBouton("Quitter");
        ...
        JButton jb_parametres = new IHMJoliBouton("Paramètres");
        ...
        // Pause
        final JButton jb_pause = new IHMJoliBouton("Pause");
        ...
        JEditorPane jep_aide =
          new JEditorPane("text/html",
                          ...
                          "Symboles :"+
                          "<ul>"+
                          "<li>un rond noir indique un philosophe mangeant;"+
        ...
        JButton jb_aide = new IHMJoliBouton("  Aide   ");
        ...
        /* ===== Le r��glage de vitesse du temps ===== */
