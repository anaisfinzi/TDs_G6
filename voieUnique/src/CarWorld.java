...
class CarWorld extends JPanel {
    ...
    /**
	 *  Gestionnaire de l'interface graphique (sprites, controller)
	 *  
	 * @author Matthieu Roy
	 */
    ...
    public CarWorld() {
	controller = new FairTrafficController();//Controller();
        MediaTracker mt = new MediaTracker(this);
	    Toolkit toolkit = Toolkit.getDefaultToolkit();

        redCar = toolkit.getImage("redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("bridge1.gif");
